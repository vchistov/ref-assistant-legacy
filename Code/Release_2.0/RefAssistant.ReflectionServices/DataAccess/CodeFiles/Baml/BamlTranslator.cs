...
namespace Lardite.RefAssistant.ReflectionServices.DataAccess.CodeFiles.Baml
{
    ...
    internal class BamlTranslator
    {
        ...
        /// </summary>
        /// <returns>Returns <see cref="TypeDeclaration"/> collection.</returns>
        internal IEnumerable<TypeDeclaration> GetDeclaredTypes()
        {
            return typeTable.Values.Cast<TypeDeclaration>();
        }
